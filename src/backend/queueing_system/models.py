...
class CustomUser(AbstractUser): # here we are extending django's built in abstractuser models to support user types
    ...
    pc_number = models.IntegerField(null=True)
    lab_id = models.CharField(max_length=10, default="")
...
class HelpRequest(models.Model):
    ...
    description = models.TextField(blank=True, default="")    # The description of the problem faced by the student
